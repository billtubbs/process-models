...
%
% Dynamics of a continuous-time nonlinear model of CSTR
% reactor model
%
% Description:
% - Constinuously-stirred reactor (CSTR) system for the 
%   free-radical polymerization of methyl methacrylate (MMA)
%   with azo-bis-isobutyronitrile (AIBN) as initiator and
%   toluene as solvent.
%
% See :
